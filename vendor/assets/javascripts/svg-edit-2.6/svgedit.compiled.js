...
(function() {
    ...
    svgedit.units.convertUnit = function(e, f) {
        f = f || s.getBaseUnit();
        return svgedit.units.shortFloat(e / v[f])
    };
    ...
    (function() {
        ...
        $(a).mousedown(function(h) {
            if (!(e.spaceKey || h.button === 1)) {
                ...
                nb = $('#svgcontent g')[0].getScreenCTM().inverse();
        ...
        s.init = function() {
            ...
            var Cb = function() {
                ...
                lc = function() {
                    ...
                    window.canvg ? l.rasterExport() : a.getScript("/assets/svg-edit-2.6/canvg/rgbcolor.js", function() {
                        a.getScript("/assets/svg-edit-2.6/canvg/canvg.js", function() {
                            l.rasterExport()
                        })
                    })
                },
            ...
            setTimeout(function() {
                    l.embedImage("/assets/svg-edit-2.6/images/logo.png", function(g) {
                        if (!g) {
